...
const Sidebar = () => {
  ...
  //gets value from global state wether the sidebar is collapsed or not
  ...
  const sidebarClass = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300 h-full z-40
                        bg-white overflow-y-auto dark:bg-black
      ...
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          ...
          {isSidebarCollapsed ? null : (
            ...
            </button>  //the button to open the sidebar state has been managed in navbar
          )}
        </div>
        {/*TEAMS*/}
...
const SidebarLink = ({
  ...
  const isActive = pathname === href || (pathname === '/' && href === '/dashboard');
    ...
    return (
      <Link href={href} className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black
